  ...
  : QSlider(parent)
{
  ...
  QString path = QDir::fromNativeSeparators("C:\\DBtests\\ArchView_my\\build-ArchView-Desktop_Qt_5_15_2_MSVC2019_64bit-Debug\\debug\\handle.png");
...
{
  parent = _parent;
  filter = new RangeEventFilter(parent);

  //styling
  setAcceptDrops(true);
  //hard coded path to image :/ sorry
  QPixmap pix = QPixmap("C:\\DBtests\\ArchView_my\\build-ArchView-Desktop_Qt_5_15_2_MSVC2019_64bit-Debug\\debug\\handle.png");
...
bool RangeEventFilter::eventFilter(QObject* obj, QEvent* event)
{
  switch(event->type())
  {
